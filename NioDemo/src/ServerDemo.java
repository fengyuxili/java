...
public class ServerDemo {
    ...
    // 本地字符集
    private static final String LOCAL_CHAR_SET_NAME = "UTF-8";
                ...
                if (key.isReadable()) {
                    ...
                    if (bytesRead == -1) {
                        ...
                        String receivedString = Charset
                                .forName(LOCAL_CHAR_SET_NAME).newDecoder().decode(buffer).toString();
                        ...
                        buffer = ByteBuffer.wrap(sendString.getBytes(LOCAL_CHAR_SET_NAME));
