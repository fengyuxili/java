...
public class ClientDemo2 {
    ...
    public ClientDemo2()throws IOException{
        SocketChannel socketChannel = SocketChannel.open();
        socketChannel.connect(new InetSocketAddress(InetAddress.getLocalHost(),8086));
    ...
    public static void main(String[] args) throws Exception{
        final ClientDemo2 client=new ClientDemo2();
